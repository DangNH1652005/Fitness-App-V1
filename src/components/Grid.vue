...
<template>
    <section id="grid">
        <button :disabled="workoutIdx > 0 && workoutIdx > firstInCompleteWorkoutIndex" @click="() => handleSelectWorkout(workoutIdx)"
            :key="workoutIdx" v-for="(workout, workoutIdx) in Object.keys(workoutProgram)" 
